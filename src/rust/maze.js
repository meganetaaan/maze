...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'maze.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'maze.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'maze.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "maze.js.mem" : null;




var STATIC_BUMP = 16288;
...
Module['wasmTableSize'] = 2624;

Module['wasmMaxTableSize'] = 2624;
...
var real__wasm_array_to_js = asm["_wasm_array_to_js"]; asm["_wasm_array_to_js"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__wasm_array_to_js.apply(null, arguments);
};
